...
export default class CreateOrder extends FireblocksBaseCommand {
  ...
  async run(): Promise<unknown> {
    const {flags} = await this.parse(CreateOrder)
    ...
    await this.confirmOrAbort('POST', '/v1/trading/orders')
